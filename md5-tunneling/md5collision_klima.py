...
References
[Ri92] Ronald Rivest: The MD5 Message Digest Algorithm, RFC1321, April 1992,
ftp:#ftp.rfc-editor.org/in-notes/rfc1321.txt

[WFLY04] Xiaoyun Wang, Dengguo Feng , Xuejia Lai, Hongbo Yu: Collisions
...
[HPR04 ] Philip Hawkes, Michael Paddon, Gregory G. Rose: Musings on the Wang et al. MD5 Collision,
Cryptology ePrint Archive, Report 2004/264, 13 October 2004, http:#eprint.iacr.org/2004/264.pdf

[Kli05a] Vlastimil Klima: Finding MD5 Collisions - a Toy For a Notebook, Cryptology ePrint Archive, Report 2005/075,
http:#eprint.iacr.org/2005/075.pdf, March 5, 2005

[Kli05b] Vlastimil Klima: Finding MD5 Collisions on a Notebook PC
...
[YaSh05] Jun Yajima and Takeshi Shimoyama: Wang's sufficient conditions of MD5
...
ePrint Archive: Report 2005/400, 7 Nov 2005, http:#eprint.iacr.org/2005/400.pdf
[LiLa05] Liang J. and Lai X.: Improved Collision Attack on Hash Function MD5,
Cryptology ePrint Archive: Report 425/2005, 23 Nov 2005, http:#eprint.iacr.org/2005/425.pdf.
...
Copyright: Vlastimil Klima, Copyright: Vlastimil Klima, http://cryptography.hyperlink.cz
"""
...
def findBlock1():
    ...
    while True:
        ...
        Q[18] = ((Q[17] + cls(((Q[16] ^ (Q[15] & (Q[17] ^ Q[16]))) + Q[14] + x[6] + 0xc040b340) & 0xFFFFFFFF, 9))
                 & 0xFFFFFFFF)
        ...
        Q[21] = ((Q[20] + cls(((Q[19] ^ (Q[18] & (Q[20] ^ Q[19]))) + Q[17] + x[5] + 0xd62f105d) & 0xFFFFFFFF, 5))
                 & 0xFFFFFFFF)
        if ((Q[21] ^ Q[20]) & 0x80020000) != 0:
            continue

        Q[22] = ((Q[21] + cls(((Q[20] ^ (Q[19] & (Q[21] ^ Q[20]))) + Q[18] + x[10] + 0x2441453) & 0xFFFFFFFF, 9))
                 & 0xFFFFFFFF)
        ...
        Q[24] = ((Q[23] + cls(((Q[22] ^ (Q[21] & (Q[23] ^ Q[22]))) + Q[20] + x[4] + 0xe7d3fbc8) & 0xFFFFFFFF, 20))
                 & 0xFFFFFFFF)
        ...
        for Q10 in range(8):  # 3 bits
            ...
            for Q20 in range(64):  # 6 bits
                Q[3] = tempq3
                Q[4] = tempq4
                x[1] = tempx1
                x[15] = tempx15
                Q[20] = tempq20 ^ maskQ20[Q20]
                x[0] = (crs((Q[20] - Q[19]) % (1 << 32), 20) - (Q[18] ^ (Q[17] & (Q[19] ^ Q[18])))
                        - Q[16] - 0xe9b6c7aa) % (1 << 32)
                Q[1] = (QM0 + cls(((QM2 ^ (QM0 & (QM1 ^ QM2))) + QM3 + x[0] + 0xd76aa478) & 0xFFFFFFFF, 7)) & 0xFFFFFFFF
                Q[2] = ((Q[1] + cls(((QM1 ^ (Q[1] & (QM0 ^ QM1))) + QM2 + x[1] + 0xe8c7b756) & 0xFFFFFFFF, 12))
                        & 0xFFFFFFFF)
                x[5] = ((crs((Q[6] - Q[5]) % (1 << 32), 12) - (Q[3] ^ (Q[5] & (Q[4] ^ Q[3]))) - Q[2] - 0x4787c62a)
                        % (1 << 32))
                Q[21] = ((Q[20]
                          + cls(((Q[19] ^ (Q[18] & (Q[20] ^ Q[19]))) + Q[17] + x[5] + 0xd62f105d) & 0xFFFFFFFF, 5))
                         & 0xFFFFFFFF)
                if ((Q[21] ^ Q[20]) & 0x80020000) != 0:
                    continue
                Q[22] = ((Q[21]
                          + cls(((Q[20] ^ (Q[19] & (Q[21] ^ Q[20]))) + Q[18] + x[10] + 0x2441453) & 0xFFFFFFFF, 9))
                         & 0xFFFFFFFF)
                if (Q[22] & longmask[32]) != bit_Q15_32:
                    continue
                tt23 = ((Q[21] ^ (Q[20] & (Q[22] ^ Q[21]))) + Q[19] + x[15] + 0xd8a1e681) & 0xFFFFFFFF
                ...
                x[4] = ((crs((Q[5] - Q[4]) % (1 << 32), 7) - (Q[2] ^ (Q[4] & (Q[3] ^ Q[2]))) - Q[1] - 0xf57c0faf)
                        % (1 << 32))
                Q[24] = ((Q[23]
                          + cls(((Q[22] ^ (Q[21] & (Q[23] ^ Q[22]))) + Q[20] + x[4] + 0xe7d3fbc8) & 0xFFFFFFFF, 20))
                         & 0xFFFFFFFF)
                if (Q[24] & longmask[32]) != longmask[32]:
                    continue
                ...
                for Q13 in range(4096):  # 12 bits
                    ...
                    x[1] = (crs((Q[17] - Q[16]) % (1 << 32), 5) - (Q[15] ^ (Q[14] & (Q[16] ^ Q[15])))
                            - Q[13] - 0xf61e2562) % (1 << 32)
                    Q[2] = ((Q[1] + cls(((QM1 ^ (Q[1] & (QM0 ^ QM1))) + QM2 + x[1] + 0xe8c7b756) & 0xFFFFFFFF, 12))
                            & 0xFFFFFFFF)
                    x[5] = (crs((Q[6] - Q[5]) % (1 << 32), 12) - (Q[3] ^ (Q[5] & (Q[4] ^ Q[3])))
                            - Q[2] - 0x4787c62a) % (1 << 32)
                    Q[21] = ((Q[20]
                              + cls(((Q[19] ^ (Q[18] & (Q[20] ^ Q[19]))) + Q[17] + x[5] + 0xd62f105d) & 0xFFFFFFFF, 5))
                             & 0xFFFFFFFF)
                    ...
                    x[15] = (crs((Q[16] - Q[15]) % (1 << 32), 22) - (Q[13] ^ (Q[15] & (Q[14] ^ Q[13])))
                             - Q[12] - 0x49b40821) % (1 << 32)
                    tt23 = ((Q[21] ^ (Q[20] & (Q[22] ^ Q[21]))) + Q[19] + x[15] + 0xd8a1e681) & 0xFFFFFFFF
                    if (tt23 & longmask[18]) != 0:
                        continue
                    Q[23] = (Q[22] + cls(tt23, 14)) & 0xFFFFFFFF
                    ...
                    for Q14 in range(512):
                        ...
                        x[2] = (crs((Q[3] - Q[2]) % (1 << 32), 17) - (QM0 ^ (Q[2] & (Q[1] ^ QM0)))
                                - QM1 - 0x242070db) % (1 << 32)

                        B2a = (x[2] + 0xfcefa3f8) & 0xFFFFFFFF

                        Q[4] = Q[4] ^ 0x02000000
                        x[4] = (crs((Q[5] - Q[4]) % (1 << 32), 7) - (Q[2] ^ (Q[4] & (Q[3] ^ Q[2])))
                                - Q[1] - 0xf57c0faf) % (1 << 32)
                        Q[24] = (Q[23]
                                 + cls(((Q[22] ^ (Q[21] & (Q[23] ^ Q[22]))) + Q[20] + x[4] + 0xe7d3fbc8)
                                       & 0xFFFFFFFF, 20)) & 0xFFFFFFFF
                        if (Q[24] & longmask[32]) != longmask[32]:
                            continue

                        Q[14] = (maskQ14[Q14] + hQ14p) & 0xFFFFFFFF

                        x[6] = (crs((Q[7] - Q[6]) % (1 << 32), 17) - (Q[4] ^ (Q[6] & (Q[5] ^ Q[4])))
                                - Q[3] - 0xa8304613) % (1 << 32)

                        x[3] = (crs((Q[4] - Q[3]) % (1 << 32), 22)
                                - (Q[1] ^ (Q[3] & (Q[2] ^ Q[1]))) - QM0 - 0xc1bdceee) % (1 << 32)
                        x[7] = (crs((Q[8] - Q[7]) % (1 << 32), 22) - (Q[5] ^ (Q[7] & (Q[6] ^ Q[5])))
                                - Q[4] - 0xfd469501) % (1 << 32)
                        x[13] = (crs((Q[14] - Q[13]) % (1 << 32), 12) - (Q[11] ^ (Q[13] & (Q[12] ^ Q[11])))
                                 - Q[10] - 0xfd987193) % (1 << 32)
                        x[14] = (crs((Q[15] - Q[14]) % (1 << 32), 17) - (Q[12] ^ (Q[14] & (Q[13] ^ Q[12])))
                                 - Q[11] - 0xa679438e) % (1 << 32)
                        ...
                        for Q9 in range(8):  # 8
                            ...
                            Q[25] = ((Q[24] + cls(((Q[23] ^ (Q[22] & (Q[24] ^ Q[23]))) + B1b + x[9]) & 0xFFFFFFFF, 5))
                                     & 0xFFFFFFFF)

                            Q[26] = ((Q[25] + cls(((Q[24] ^ (Q[23] & (Q[25] ^ Q[24]))) + B3a) & 0xFFFFFFFF, 9))
                                     & 0xFFFFFFFF)

                            Q[27] = ((Q[26] + cls(((Q[25] ^ (Q[24] & (Q[26] ^ Q[25]))) + B3b) & 0xFFFFFFFF, 14))
                                     & 0xFFFFFFFF)

                            Q[28] = ((Q[27] + cls(((Q[26] ^ (Q[25] & (Q[27] ^ Q[26]))) + x[8] + B3c) & 0xFFFFFFFF, 20))
                                     & 0xFFFFFFFF)

                            Q[29] = ((Q[28] + cls(((Q[27] ^ (Q[26] & (Q[28] ^ Q[27]))) + Q[25] + B3d) & 0xFFFFFFFF, 5))
                                     & 0xFFFFFFFF)

                            Q[30] = ((Q[29] + cls(((Q[28] ^ (Q[27] & (Q[29] ^ Q[28]))) + Q[26] + B2a) & 0xFFFFFFFF, 9))
                                     & 0xFFFFFFFF)

                            Q[31] = ((Q[30] + cls(((Q[29] ^ (Q[28] & (Q[30] ^ Q[29]))) + Q[27] + B3e) & 0xFFFFFFFF, 14))
                                     & 0xFFFFFFFF)
                            Q[32] = ((Q[31] + cls(
                                ((Q[30] ^ (Q[29] & (Q[31] ^ Q[30]))) + Q[28] + x[12] + 0x8d2a4c8a) & 0xFFFFFFFF, 20))
                                     & 0xFFFFFFFF)

                            Q[33] = (Q[32] + cls(((Q[32] ^ Q[31] ^ Q[30]) + Q[29] + B1c) & 0xFFFFFFFF, 4)) & 0xFFFFFFFF
                            ...
                            # B3f = (x[14] + 0xfde5380c) & 0xFFFFFFFF
                            Q[36] = (Q[35] + cls(((Q[35] ^ Q[34] ^ Q[33]) + Q[32] + B3f) & 0xFFFFFFFF, 23)) & 0xFFFFFFFF
                            # B1d = ( x[1] + 0xa4beea44) & 0xFFFFFFFF
                            Q[37] = (Q[36] + cls(((Q[36] ^ Q[35] ^ Q[34]) + Q[33] + B1d) & 0xFFFFFFFF, 4)) & 0xFFFFFFFF

                            # B3g = (x[4] + 0x4bdecfa9) & 0xFFFFFFFF
                            Q[38] = (Q[37] + cls(((Q[37] ^ Q[36] ^ Q[35]) + Q[34] + B3g) & 0xFFFFFFFF, 11)) & 0xFFFFFFFF

                            # B3h = (x[7] + 0xf6bb4b60) & 0xFFFFFFFF
                            Q[39] = (Q[38] + cls(((Q[38] ^ Q[37] ^ Q[36]) + Q[35] + B3h) & 0xFFFFFFFF, 16)) & 0xFFFFFFFF
                            ...
                            # B3i = (x[13] + 0x289b7ec6) & 0xFFFFFFFF
                            Q[41] = (Q[40] + cls(((Q[40] ^ Q[39] ^ Q[38]) + Q[37] + B3i) & 0xFFFFFFFF, 4)) & 0xFFFFFFFF
                            ...
                            # B3j = (x[3] + 0xd4ef3085) & 0xFFFFFFFF
                            Q[43] = (Q[42] + cls(((Q[42] ^ Q[41] ^ Q[40]) + Q[39] + B3j) & 0xFFFFFFFF, 16)) & 0xFFFFFFFF

                            # B3k = (x[6] + 0x4881d05) & 0xFFFFFFFF
                            Q[44] = (Q[43] + cls(((Q[43] ^ Q[42] ^ Q[41]) + Q[40] + B3k) & 0xFFFFFFFF, 23)) & 0xFFFFFFFF
                            Q[45] = ((Q[44] + cls(((Q[44] ^ Q[43] ^ Q[42]) + Q[41] + x[9] + 0xd9d4d039) & 0xFFFFFFFF,
                                                  4))
                                     & 0xFFFFFFFF)
                            Q[46] = (Q[45] + cls(
                                ((Q[45] ^ Q[44] ^ Q[43]) + Q[42] + x[12] + 0xe6db99e5) & 0xFFFFFFFF, 11)) & 0xFFFFFFFF

                            # B1e = (x[15] + 0x1fa27cf8) & 0xFFFFFFFF
                            Q[47] = (Q[46] + cls(((Q[46] ^ Q[45] ^ Q[44]) + Q[43] + B1e) & 0xFFFFFFFF, 16)) & 0xFFFFFFFF

                            # B3l = (x[2] + 0xc4ac5665) & 0xFFFFFFFF
                            Q[48] = (Q[47] + cls(((Q[47] ^ Q[46] ^ Q[45]) + Q[44] + B3l) & 0xFFFFFFFF, 23)) & 0xFFFFFFFF
                            ...
                            # B02b = (x[0] + 0xf4292244) & 0xFFFFFFFF
                            Q[49] = ((Q[48] + cls(((Q[47] ^ (Q[48] | ~Q[46])) + Q[45] + B02b) & 0xFFFFFFFF, 6))
                                     & 0xFFFFFFFF)
                            ...
                            if (Q[53] & longmask[32]) != bitJ:
                                continue
                            Q[54] = (Q[53] + cls(
                                ((Q[52] ^ (Q[53] | ~Q[51])) + Q[50] + x[3] + 0x8f0ccc92) & 0xFFFFFFFF, 10)) & 0xFFFFFFFF
                            ...
                            if (Q[55] & longmask[32]) != bitJ:
                                continue
                            Q[56] = ((Q[55]
                                      + cls(((Q[54] ^ (Q[55] | ~Q[53])) + Q[52] + x[1] + 0x85845dd1) & 0xFFFFFFFF, 21))
                                     & 0xFFFFFFFF)
                            if (Q[56] & longmask[32]) != bit_I_neg:
                                continue
                            Q[57] = ((Q[56]
                                      + cls(((Q[55] ^ (Q[56] | ~Q[54])) + Q[53] + x[8] + 0x6fa87e4f) & 0xFFFFFFFF, 6))
                                     & 0xFFFFFFFF)
                            if (Q[57] & longmask[32]) != bitJ:
                                continue
                            Q[58] = ((Q[57]
                                      + cls(((Q[56] ^ (Q[57] | ~Q[55])) + Q[54] + x[15] + 0xfe2ce6e0) & 0xFFFFFFFF, 10))
                                     & 0xFFFFFFFF)
                            if (Q[58] & longmask[32]) != bit_I_neg:
                                continue
                            Q[59] = ((Q[58]
                                      + cls(((Q[57] ^ (Q[58] | ~Q[56])) + Q[55] + x[6] + 0xa3014314) & 0xFFFFFFFF, 15))
                                     & 0xFFFFFFFF)
                            if (Q[59] & longmask[32]) != bitJ:
                                continue
                            Q[60] = ((Q[59]
                                      + cls(((Q[58] ^ (Q[59] | ~Q[57])) + Q[56] + x[13] + 0x4e0811a1) & 0xFFFFFFFF, 21))
                                     & 0xFFFFFFFF)
                            ...
                            if (Q[60] & longmask[26]) != 0:
                                continue
                            Q[61] = ((Q[60]
                                      + cls(((Q[59] ^ (Q[60] | ~Q[58])) + Q[57] + x[4] + 0xf7537e82) & 0xFFFFFFFF, 6))
                                     & 0xFFFFFFFF)
                            ...
                            Q[63] = ((Q[62]
                                      + cls(((Q[61] ^ (Q[62] | ~Q[60])) + Q[59] + x[2] + 0x2ad7d2bb) & 0xFFFFFFFF, 15))
                                     & 0xFFFFFFFF)
                            Q[64] = ((Q[63]
                                      + cls(((Q[62] ^ (Q[63] | ~Q[61])) + Q[60] + x[9] + 0xeb86d391) & 0xFFFFFFFF, 21))
                                     & 0xFFFFFFFF)

                            IHV[0] = (IV[0] + Q[61]) & 0xFFFFFFFF
            ...
            for cq4 in range(64):
                ...
                for cq9 in range(256):
                    ...
                    x[8] = ((crs((Q[9] - Q[8]) % (1 << 32), 7) - (Q[6] ^ (Q[8] & (Q[7] ^ Q[6]))) - Q[5] - 0x698098d8)
                            % (1 << 32))
                    x[9] = (crs((Q[10] - Q[9]) % (1 << 32), 12) - (Q[7] ^ (Q[9] & (Q[8] ^ Q[7])))
                            - Q[6] - 0x8b44f7af) % (1 << 32)
                    x[12] = (crs((Q[13] - Q[12]) % (1 << 32), 7) - (Q[10] ^ (Q[12] & (Q[11] ^ Q[10])))
                             - Q[9] - 0x6b901122) % (1 << 32)

                    Q[25] = ((Q[24]
                             + cls(((Q[23] ^ (Q[22] & (Q[24] ^ Q[23]))) + Q[21] + x[9] + 0x21e1cde6) & 0xFFFFFFFF,5))
                             & 0xFFFFFFFF)
                    Q[26] = ((Q[25] + cls(
                        ((Q[24] ^ (Q[23] & (Q[25] ^ Q[24]))) + Q[22] + x[14] + 0xc33707d6) & 0xFFFFFFFF,9))
                             & 0xFFFFFFFF)
                    Q[27] = ((Q[26]
                             + cls(((Q[25] ^ (Q[24] & (Q[26] ^ Q[25]))) + Q[23] + x[3] + 0xf4d50d87) & 0xFFFFFFFF,14))
                             & 0xFFFFFFFF)
                    Q[28] = ((Q[27]
                             + cls(((Q[26] ^ (Q[25] & (Q[27] ^ Q[26]))) + Q[24] + x[8] + 0x455a14ed) & 0xFFFFFFFF,20))
                             & 0xFFFFFFFF)
                    Q[29] = ((Q[28]
                             + cls(((Q[27] ^ (Q[26] & (Q[28] ^ Q[27]))) + Q[25] + x[13] + 0xa9e3e905) & 0xFFFFFFFF,5))
                             & 0xFFFFFFFF)
                    Q[30] = ((Q[29]
                             + cls(((Q[28] ^ (Q[27] & (Q[29] ^ Q[28]))) + Q[26] + x[2] + 0xfcefa3f8) & 0xFFFFFFFF,9))
                             & 0xFFFFFFFF)
                    Q[31] = ((Q[30]
                             + cls(((Q[29] ^ (Q[28] & (Q[30] ^ Q[29]))) + Q[27] + x[7] + 0x676f02d9) & 0xFFFFFFFF,14))
                             & 0xFFFFFFFF)
                    Q[32] = ((Q[31]
                             + cls(((Q[30] ^ (Q[29] & (Q[31] ^ Q[30]))) + Q[28] + x[12] + 0x8d2a4c8a) & 0xFFFFFFFF,20))
                             & 0xFFFFFFFF)
                    Q[33] = (Q[32]
                             + cls(((Q[32] ^ Q[31] ^ Q[30]) + Q[29] + x[5] + 0xfffa3942) & 0xFFFFFFFF,4)) & 0xFFFFFFFF
                    Q[34] = (Q[33]
                             + cls(((Q[33] ^ Q[32] ^ Q[31]) + Q[30] + x[8] + 0x8771f681) & 0xFFFFFFFF,11)) & 0xFFFFFFFF
                    ...
                    Q[36] = ((Q[35] + cls(((Q[35] ^ Q[34] ^ Q[33]) + Q[32] + x[14] + 0xfde5380c) & 0xFFFFFFFF,23))
                             & 0xFFFFFFFF)
                    Q[37] = ((Q[36] + cls(((Q[36] ^ Q[35] ^ Q[34]) + Q[33] + x[1] + 0xa4beea44) & 0xFFFFFFFF,4))
                             & 0xFFFFFFFF)
                    Q[38] = ((Q[37] + cls(((Q[37] ^ Q[36] ^ Q[35]) + Q[34] + x[4] + 0x4bdecfa9) & 0xFFFFFFFF,11))
                             & 0xFFFFFFFF)
                    Q[39] = ((Q[38] + cls(((Q[38] ^ Q[37] ^ Q[36]) + Q[35] + x[7] + 0xf6bb4b60) & 0xFFFFFFFF,16))
                             & 0xFFFFFFFF)
                    Q[40] = ((Q[39] + cls(((Q[39] ^ Q[38] ^ Q[37]) + Q[36] + x[10] + 0xbebfbc70) & 0xFFFFFFFF,23))
                             & 0xFFFFFFFF)
                    Q[41] = ((Q[40] + cls(((Q[40] ^ Q[39] ^ Q[38]) + Q[37] + x[13] + 0x289b7ec6) & 0xFFFFFFFF,4))
                             & 0xFFFFFFFF)
                    Q[42] = ((Q[41] + cls(((Q[41] ^ Q[40] ^ Q[39]) + Q[38] + x[0] + 0xeaa127fa) & 0xFFFFFFFF,11))
                             & 0xFFFFFFFF)
                    Q[43] = ((Q[42] + cls(((Q[42] ^ Q[41] ^ Q[40]) + Q[39] + x[3] + 0xd4ef3085) & 0xFFFFFFFF,16))
                             & 0xFFFFFFFF)
                    Q[44] = ((Q[43] + cls(((Q[43] ^ Q[42] ^ Q[41]) + Q[40] + x[6] + 0x4881d05) & 0xFFFFFFFF,23))
                             & 0xFFFFFFFF)
                    Q[45] = ((Q[44] + cls(((Q[44] ^ Q[43] ^ Q[42]) + Q[41] + x[9] + 0xd9d4d039) & 0xFFFFFFFF,4))
                             & 0xFFFFFFFF)
                    Q[46] = ((Q[45] + cls(((Q[45] ^ Q[44] ^ Q[43]) + Q[42] + x[12] + 0xe6db99e5) & 0xFFFFFFFF,11))
                             & 0xFFFFFFFF)
                    Q[47] = ((Q[46] + cls(((Q[46] ^ Q[45] ^ Q[44]) + Q[43] + x[15] + 0x1fa27cf8) & 0xFFFFFFFF,16))
                             & 0xFFFFFFFF)
                    Q[48] = ((Q[47] + cls(((Q[47] ^ Q[46] ^ Q[45]) + Q[44] + x[2] + 0xc4ac5665) & 0xFFFFFFFF,23))
                             & 0xFFFFFFFF)
                    ...
                    Q[49] = ((Q[48] + cls(((Q[47] ^ (Q[48] | ~Q[46])) + Q[45] + x[0] + 0xf4292244) & 0xFFFFFFFF,6))
                             & 0xFFFFFFFF)
                    bitK = Q[47] & longmask[32]
                    if (Q[49] & longmask[32]) != bitK:
                        continue

                    Q[50] = ((Q[49] + cls(((Q[48] ^ (Q[49] | ~Q[47])) + Q[46] + x[7] + 0x432aff97) & 0xFFFFFFFF,10))
                             & 0xFFFFFFFF)
                    bit_J_neg = bitJ ^ longmask[32]
                    if (Q[50] & longmask[32]) != bit_J_neg:
                        continue

                    Q[51] = ((Q[50] + cls(((Q[49] ^ (Q[50] | ~Q[48])) + Q[47] + x[14] + 0xab9423a7) & 0xFFFFFFFF,15))
                             & 0xFFFFFFFF)
                    if (Q[51] & longmask[32]) != bitK:
                        continue
                    Q[52] = ((Q[51] + cls(((Q[50] ^ (Q[51] | ~Q[49])) + Q[48] + x[5] + 0xfc93a039) & 0xFFFFFFFF,21))
                             & 0xFFFFFFFF)
                    if (Q[52] & longmask[32]) != bit_J_neg:
                        continue
                    Q[53] = ((Q[52] + cls(((Q[51] ^ (Q[52] | ~Q[50])) + Q[49] + x[12] + 0x655b59c3) & 0xFFFFFFFF,6))
                             & 0xFFFFFFFF)
                    if (Q[53] & longmask[32]) != bitK:
                        continue
                    Q[54] = ((Q[53] + cls(((Q[52] ^ (Q[53] | ~Q[51])) + Q[50] + x[3] + 0x8f0ccc92) & 0xFFFFFFFF,10))
                             & 0xFFFFFFFF)
                    if (Q[54] & longmask[32]) != bit_J_neg:
                        continue
                    Q[55] = ((Q[54] + cls(((Q[53] ^ (Q[54] | ~Q[52])) + Q[51] + x[10] + 0xffeff47d) & 0xFFFFFFFF,15))
                             & 0xFFFFFFFF)
                    if (Q[55] & longmask[32]) != bitK:
                        continue
                    Q[56] = ((Q[55] + cls(((Q[54] ^ (Q[55] | ~Q[53])) + Q[52] + x[1] + 0x85845dd1) & 0xFFFFFFFF,21))
                             & 0xFFFFFFFF)
                    if (Q[56] & longmask[32]) != bit_J_neg:
                        continue
                    Q[57] = ((Q[56] + cls(((Q[55] ^ (Q[56] | ~Q[54])) + Q[53] + x[8] + 0x6fa87e4f) & 0xFFFFFFFF,6))
                             & 0xFFFFFFFF)
                    if (Q[57] & longmask[32]) != bitK:
                        continue
                    Q[58] = ((Q[57] + cls(((Q[56] ^ (Q[57] | ~Q[55])) + Q[54] + x[15] + 0xfe2ce6e0) & 0xFFFFFFFF,10))
                             & 0xFFFFFFFF)
                    if (Q[58] & longmask[32]) != bit_J_neg:
                        continue
                    Q[59] = ((Q[58] + cls(((Q[57] ^ (Q[58] | ~Q[56])) + Q[55] + x[6] + 0xa3014314) & 0xFFFFFFFF,15))
                             & 0xFFFFFFFF)
                    if (Q[59] & longmask[32]) != bitK:
                        continue
                    Q[60] = ((Q[59] + cls(((Q[58] ^ (Q[59] | ~Q[57])) + Q[56] + x[13] + 0x4e0811a1) & 0xFFFFFFFF,21))
                             & 0xFFFFFFFF)
                    if (Q[60] & longmask[32]) != bitJ:
                        continue
                    if (Q[60] & longmask[26]) != 0:
                        continue
                    Q[61] = ((Q[60] + cls(((Q[59] ^ (Q[60] | ~Q[58])) + Q[57] + x[4] + 0xf7537e82) & 0xFFFFFFFF,6))
                             & 0xFFFFFFFF)
                    ...
                    if (Q[62] & longmask[26]) != longmask[26]:
                        continue
                    Q[63] = ((Q[62] + cls(((Q[61] ^ (Q[62] | ~Q[60])) + Q[59] + x[2] + 0x2ad7d2bb) & 0xFFFFFFFF,15))
                             & 0xFFFFFFFF)
                    if (Q[63] & longmask[32]) != bitK:
                        continue
                    if (Q[63] & longmask[26]) != longmask[26]:
                        continue
                    Q[64] = ((Q[63] + cls(((Q[62] ^ (Q[63] | ~Q[61])) + Q[60] + x[9] + 0xeb86d391) & 0xFFFFFFFF,21))
                             & 0xFFFFFFFF)
                    ...
                    md5.compress(IHV_1, x)  # Compression of P_HIHV1 is already done before ^
