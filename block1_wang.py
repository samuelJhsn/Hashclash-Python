...
def find_block1_wang(IV):
    ...
    while True:
        ...
        Q[5] = (random.randrange(0, (2 ** 32)) & 0x71de7799) | 0x0c008840 | bb
        Q[6] = (random.randrange(0, (2 ** 32)) & 0x01c06601) | 0x3e1f0966 | (Q[5] & 0x80000018)
        Q[7] = 0x3a040010 | (Q[6] & 0x80000601)
        Q[8] = (random.randrange(0, (2 ** 32)) & 0x03c0e000) | 0x482f0e50 | aa
        Q[9] = (random.randrange(0, (2 ** 32)) & 0x600c0000) | 0x05e2ec56 | aa
        Q[10] = (random.randrange(0, (2 ** 32)) & 0x604c203e) | 0x16819e01 | bb | (Q[9] & 0x01000000)
        Q[11] = (random.randrange(0, (2 ** 32)) & 0x604c7c1c) | 0x043283e0 | (Q[10] & 0x80000002)
        Q[12] = (random.randrange(0, (2 ** 32)) & 0x00002800) | 0x1c0101c1 | (Q[11] & 0x80001000)
        Q[13] = 0x078bcbc0 | bb
        Q[14] = (random.randrange(0, (2 ** 32)) & 0x07800000) | 0x607dc7df | bb
        Q[15] = (random.randrange(0, (2 ** 32)) & 0x00f00f7f) | 0x00081080 | (Q[14] & 0xe7000000)
        Q[16] = (random.randrange(0, (2 ** 32)) & 0x00701f77) | 0x3f0fe008 | aa
        Q[17] = (random.randrange(0, (2 ** 32)) & 0x00701f77) | 0x408be088 | aa
        Q[18] = (random.randrange(0, (2 ** 32)) & 0x00ff3ff7) | 0x7d000000
        Q[19] = (random.randrange(0, (2 ** 32)) & 0x4ffdffff) | 0x20000000 | (~Q[18] & 0x00020000)
        ...
        while counter < (1 << 12):
            ...
            q1 = q1a | (random.randrange(0, (2 ** 32)) & 0x01c0e71f)
            ...
            block[0] = m0
            block[1] = m1
            block[2] = block[2] = md5.md5_reverse_step(2, Q, 0x242070db, 17)
        ...
        tt21 = ((md5.G(Q[23], Q[22], Q[21]) + Q[20] + 0xd62f105d) & 0xFFFFFFFF) & 0xFFFFFFFF
        ...
        while counter2 < (1 << 5):
            ...
            Q[12] = q9
            Q[13] = q10
            block[13] = block[13] = md5.md5_reverse_step(13, Q, 0xfd987193, 12)
